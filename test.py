...
#load models
svm_classifiers = []
model_pathes= ['model1.sav','model2.sav','model3.sav','model4.sav','model5.sav','model6.sav','model7.sav','model8.sav','model9.sav','model10.sav']
for model_path in model_pathes:

    loaded_model = pickle.load(open(model_path, 'rb'))
    svm_classifiers.append(loaded_model)
